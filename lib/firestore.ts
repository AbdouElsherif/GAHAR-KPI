...
export interface TechnicalClinicalCorrectionRate {
    ...
    icdTotal: number | null;
    dasTotal: number | null;
    mmsTotal: number | null;
    sipTotal: number | null;
    ipcTotal: number | null;
    scmTotal: number | null;
    texTotal: number | null;
    teqTotal: number | null;
    tpoTotal: number | null;
    nsrTotal: number | null;
    sasTotal: number | null;
    actCorrected: number | null;
    icdCorrected: number | null;
    dasCorrected: number | null;
    mmsCorrected: number | null;
    sipCorrected: number | null;
    ipcCorrected: number | null;
    scmCorrected: number | null;
    texCorrected: number | null;
    teqCorrected: number | null;
    tpoCorrected: number | null;
    nsrCorrected: number | null;
    sasCorrected: number | null;
    irsTotal: number | null;
    mrsTotal: number | null;
    cpsTotal: number | null;
    lprTotal: number | null;
    lepTotal: number | null;
    lpoTotal: number | null;
    lqcTotal: number | null;
    irsCorrected: number | null;
    mrsCorrected: number | null;
    cpsCorrected: number | null;
    lprCorrected: number | null;
    lepCorrected: number | null;
    lpoCorrected: number | null;
