...
const dept6Section4AccreditationStatus = [
    ...
    'رسوم تأجيل زيارة', 'رسوم شهادات إضافية', 'رسوم خدمة مضافة'
];
...
const saveFunctions: Record<string, SaveFunctionType> = {
    ...
    'saveReviewerEvaluationVisit': saveReviewerEvaluationVisit,
    'saveReportPresentedToCommittee': saveReportPresentedToCommittee,
    'saveReportByFacilitySpecialty': saveReportByFacilitySpecialty,
    'saveAccreditationDecision': saveAccreditationDecision,
